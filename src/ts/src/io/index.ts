 ...
 *
 * 참고: fast-xml-parser/cfb/iconv-lite/unpdf 는 이 서브패스 전용 의존성 (zip 은 자체 파서) —
...
export { recordEntries, recordKeys, setField } from "./recordOrder.js";
export { normalizeForDetection, remapOffsets } from "./textNormalizer.js";
